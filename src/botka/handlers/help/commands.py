...
HELP_TEXT = (
    ...
    "/status — list who is currently in the space (residents/members).\n"
    ...
    "\n"
    "Shopping:\n"
    "/need &lt;item&gt; — add item to the shopping list (residents/members).\n"
    ...
    "/todo [&lt;id|text...&gt;] — list TODO/IN PROGRESS tasks, or show/create a task.\n"
    "/task &lt;id|text...&gt; — show full task details by id, or create a task from text.\n"
    ...
    "\n"
    "UPS:\n"
    "/ups — show current UPS / battery status.\n"
    "\n"
    "Fridge:\n"
    "/fridge — open the fridge and charge your account.\n"
    "\n"
    "Administration:\n"
